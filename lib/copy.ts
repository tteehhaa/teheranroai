...
export const COPY = {
  ko: {
    ...
    products: "프로젝트",
    howWeBuild: "만드는 방식",
    // Rendered one clause per line; joined with a space they form a single sentence.
    steps: ["현장에서 듣고,", "있는 그대로 정리하며,", "반복되는 것만 집중해서 만듭니다."],
    contact: "문의",
  ...
  en: {
    ...
    steps: ["We listen in the field,", "record it as it is,", "and build only what repeats."],
    contact: "Contact",
